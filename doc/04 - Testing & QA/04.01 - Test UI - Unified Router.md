---
title: Test UI — Unified Router
type: testing
tags: [testing, ui, router, type/plan]
status: active
updated: 2026-05-16
sources: [c02_unified_test_ui.md]
related: ["[[04.02 - Test UI - Policy Brief]]", "[[04.03 - Plan - ThaiJO Test Tab]]", "[[02.01 - Agent Workflows]]"]
---

# 04.01 - Test UI: Unified Router (`unified_test_ui.html`)

> **Multi-pipeline test harness** — 5 tabs (Unified Chat, Short Chat, Router, SSE Stream, Health). Tests routing dispatch across all 3 pipelines (chat, policy_brief, short_chat).
> Companion docs: [[04.02 - Test UI - Policy Brief]] (Policy Brief UI spec), [[04.03 - Plan - ThaiJO Test Tab]] (ThaiJO 5th-tab extension).
