---
title: Plan — ThaiJO Agent Test Tab (P02)
type: plan
tags: [plan, testing, ui, thaijo, type/plan, status/active]
status: active
updated: 2026-05-16
sources: [p02_agent_test_ui_tab.md]
related: ["[[04.01 - Test UI - Unified Router]]", "[[03.01 - ThaiJO Integration]]", "[[06.04 - ThaiJO Fix History]]"]
---

# 04.03 - Plan: ThaiJO Agent Test Tab (P02)

> **Feature add:** 5th "🧪 ทดสอบ Agent" tab in the ThaiJO research UI, plus two backend fixes (URL stripping in `_VIEW_EXTRA_SEGMENT_RE`, cache tab URL linkification).
