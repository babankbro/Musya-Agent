---
title: Test UI — Policy Brief
type: testing
tags: [testing, ui, policy-brief, design, frontend]
status: active
updated: 2026-05-16
sources: [DESIGN_TEST_AGENT_V2.md]
related: ["[[04.01 - Test UI - Unified Router]]", "[[02.01 - Agent Workflows]]", "[[05.01 - Report Writing Style]]"]
---

# 04.02 - Test UI: Policy Brief (`policy_brief_ui.html`)

> **UI/UX spec** for the Policy Brief test interface (Phase 3) — 4 tabs (Policy, Pipeline, Tools, Data), Tailwind+Thai styling, teal/emerald color palette.
> Covers component specs, color tokens, agent node states, mental-health safety disclaimers.
