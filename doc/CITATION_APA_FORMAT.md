...
### 2.3 บทความวิชาการ ThaiJO (Article) — `apa_type: "article"`

**แหล่ง**: TCI-THAIJO (Thai Journals Online) ผ่าน ThaiJO microservice
**Trust Level**: 🟡 Medium

**Bibliography:**
```
{ผู้เขียน}. ({ปี}). {ชื่อบทความ}. *{ชื่อวารสาร}*, {ปีที่}({ฉบับที่}), {หน้า}. {DOI/URL}
```

**ตัวอย่าง:**
```
สมชาย ใจดี, และ วิภา สุขสบาย. (2565). ปัจจัยเสี่ยงอุบัติเหตุทางถนนในชนบทไทย.
    *วารสารสาธารณสุขไทย*, 52(3), 45-58. https://tci-thaijo.org/...
```

**Inline citation:**
```
(สมชาย ใจดี และ วิภา สุขสบาย, 2565)
```
หรือ `[C-200]`

### 2.4 เว็บไซต์ (Website) — `apa_type: "website"`
...
| C-200 ถึง C-299 | บทความวิชาการ ThaiJO (thaijo_article) | [C-200] สมชาย ใจดี, 2565 |
| C-300+ | เว็บไซต์/เอกสารภายนอก (website/external) | [C-300] กระทรวงสาธารณสุข, 2567 |
...
|-------|------|-------------|---------|
| `apa_type` | str | ประเภทเอกสาร APA | `"report"`, `"dataset"`, `"article"`, `"website"`, `"law"` |
