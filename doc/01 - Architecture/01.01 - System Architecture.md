...
│  test_ui.py | accident_policy.py | accident_chat.py | db_explorer.py | obsidian.py │
├──────────────────────────────────────────────────────────┤
...
│  report_writer | accident_policy_agent | accident_chat_agent | obsidian_agent│
├──────────────────────────────────────────────────────────┤
│                  Tools                                      │
│  accident.py (7) | chart_builder.py (7) | thaijo.py (1)   │
│  common.py (3)   | sql_tools.py (3)     | notebooklm.py(2)│
│  zone10_accident.py (7) | obsidian.py (3)                 │
├──────────────────────────────────────────────────────────┤
│                  RAG Layer                                  │
