...
type: overview
tags: [overview, onboarding, status/active]
status: active
updated: 2026-05-16
sources: [PROJECT_DOCUMENTATION.md]
related: ["[[00 - Home]]", "[[01.01 - System Architecture]]", "[[01.03 - Database & API Reference]]", "[[02.01 - Agent Workflows]]", "[[06.01 - Implementation Status]]"]
---

# 07.01 - Project Documentation

> **Comprehensive entry-level reference** — architecture, all agents (10), API surface (~40 endpoints), DB schema, setup, design decisions.
> For the latest implementation pulse, see [[06.01 - Implementation Status]].
> For deep architecture, see [[01.01 - System Architecture]] + [[01.03 - Database & API Reference]].
...
│   ├── import_subdistrict_csv.py # CSV import script (accident2021–2026.csv)
