...
│   ├── import_subdistrict_csv.py # CSV import script (accident2020–2026.csv)
...
### Accident Policy Pipeline (Zone 10) (3 agents)
- **Zone10 SQL Fetcher** — ดึงข้อมูล 7 policy queries สำหรับเขตสุขภาพ 10 โดยใช้ 7 tools
- **Zone10 Policy Analyst** — วิเคราะห์ข้อมูลด้วยกรอบ Haddon Matrix แยก 4 หมวดนโยบาย
- **Zone10 Report Writer** — เขียนรายงานนโยบายสำหรับ สสส./สสจ./ศปถ. ในรูปแบบราชการ

---

## 5. API Endpoints (11 routers, ~42 endpoints)
