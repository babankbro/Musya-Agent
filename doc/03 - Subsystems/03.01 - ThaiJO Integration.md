---
title: ThaiJO Integration
type: subsystem
tags: [subsystem, thaijo, citation, agent, status/done]
status: done
updated: 2026-05-16
sources: [THAIJO_AGENT_IMPLEMENTATION.md]
related: ["[[03.02 - ThaiJO Research SRS]]", "[[06.04 - ThaiJO Fix History]]", "[[02.05 - Plan - Field Enricher Agent]]", "[[02.04 - Reference - APA Format]]"]
---

# 03.01 - ThaiJO Integration

> **Canonical implementation spec** for the `search_thaijo` tool, microservice contract, citation code allocation (C-200~C-299), and evidence schema.
> For the larger 6-agent ThaiJO research-report pipeline, see [[03.02 - ThaiJO Research SRS]].
> For historical bug fixes (URL hallucination, title extraction), see [[06.04 - ThaiJO Fix History]].
