...
#### `accident` — อุบัติเหตุทางถนน (Thai column names)

| Column | Type | คำอธิบาย |
|--------|------|---------|
| `id` | SERIAL (PK) | Auto-increment |
| `ปีที่เกิดเหตุ` | INTEGER | ปี พ.ศ./ค.ศ. ที่เกิดเหตุ |
| `วันที่เกิดเหตุ` | VARCHAR | วันที่เกิดเหตุ |
| `เวลา` | VARCHAR | เวลาที่เกิดเหตุ |
| `"ACC_CODE"` | BIGINT | รหัสอุบัติเหตุ |
| `จังหวัด` | TEXT | จังหวัดที่เกิดเหตุ |
| `สายทาง` | TEXT | ชื่อถนน/สายทาง |
| `"KM"` | DOUBLE PRECISION | กม. ที่เกิดเหตุ |
| `มูลเหตุสันนิษฐาน` | TEXT | สาเหตุที่คาดว่า |
| `สภาพอากาศ` | TEXT | สภาพอากาศขณะเกิดเหตุ |

> **หมายเหตุ**: ต้องใช้ double-quote ใน SQL: `SELECT "จังหวัด" FROM accident`
