---
title: Reference — APA Format
type: reference
tags: [reference, apa, citation, type/reference]
status: active
updated: 2026-05-16
sources: [CITATION_APA_FORMAT.md]
related: ["[[02.03 - Agent - Citation & Evidence]]"]
---

# 02.04 - Reference: APA Format (Thai Public Health Adaptation)

> **Companion to:** [[02.03 - Agent - Citation & Evidence]] (architecture & workflow).
> This page is the **formatting reference** — citation codes, bibliography templates, `apa_formatter.py` API.
